...
//  100+ sources across categories and languages
// ════════════════════════════════════════════════════════
...
export const GUARDIAN_BULK = [
  { sections: 'sport,football',                                        cat: 'sports',        size: 30 },
  { sections: 'film,music,television,culture,arts,stage,lifeandstyle', cat: 'entertainment', size: 30 },
  { sections: 'games',                                                  cat: 'gaming',        size: 30 },
  { sections: 'technology,science,environment',                         cat: 'technology',    size: 30 },
  { sections: 'world,us-news,uk-news,politics,business,money',         cat: 'world',         size: 30 },
];
...
// Gaming, Entertainment, Tech — direct access to any site
export const SERVER_ONLY_FEEDS = [
  // ── GAMING — major gaming publications ──
  ...
  { url:'https://www.nintendolife.com/feeds/latest',           src:'Nintendo Life',  country:'JP', cat:'gaming',       lang:'en' },
  ...
  // ── SPORTS — additional sports coverage ──
...
// RSS feeds — standard (work via proxy on client, direct on server)
export const RSS_SOURCES = [
  // ── DW (Deutsche Welle — CORS native, 20+ languages) ──
  ...
  { url:`${DW}/rss-sw-swa`, src:'DW Kiswahili',    country:'NG', cat:'world',         lang:'sw' },

  // ── BBC — ONE feed per topic (football removed, sport covers it already) ──
  { url:`${BBC}/sport/rss.xml`,                              src:'BBC',             country:'UK', cat:'sports',        lang:'en' },
  { url:`${BBC}/news/world/rss.xml`,                         src:'BBC',             country:'UK', cat:'world',         lang:'en' },
  { url:`${BBC}/news/technology/rss.xml`,                    src:'BBC',             country:'UK', cat:'technology',    lang:'en' },
  { url:`${BBC}/news/entertainment_and_arts/rss.xml`,        src:'BBC',             country:'UK', cat:'entertainment', lang:'en' },
  { url:`${BBC}/news/science_and_environment/rss.xml`,       src:'BBC',             country:'UK', cat:'technology',    lang:'en' },
  { url:`${BBC}/news/business/rss.xml`,                      src:'BBC',             country:'UK', cat:'world',         lang:'en' },
  ...
  // ── Spain — amplia cobertura ──
  { url:'https://feeds.elpais.com/mrss-s/pages/ep/site/elpais.com/portada',    src:'El País',         country:'ES', cat:'world',         lang:'es' },
  { url:'https://feeds.elpais.com/mrss-s/pages/ep/site/elpais.com/espana',     src:'El País ES',      country:'ES', cat:'world',         lang:'es' },
  ...
  // Deportes ES — URLs 100% verificadas
  ...
  { url:'https://www.20minutos.es/rss/',                        src:'20minutos',        country:'ES', cat:'sports',        lang:'es' },
  ...
  { url:'https://www.muycomputer.com/feed/',                    src:'Muy Computer',     country:'ES', cat:'technology',    lang:'es' },
  // Gaming ES
  ...
  { url:'https://www.eleconomista.es/rss/rss-seleccion-ee.php', src:'El Economista ES', country:'ES', cat:'world',         lang:'es' },
  // Entretenimiento ES
  ...
  { url:'https://www.tf1info.fr/rss.xml',                     src:'TF1',             country:'FR', cat:'world',         lang:'fr' },
  ...
  { url:'https://www.spiegel.de/schlagzeilen/index.rss',      src:'Spiegel',         country:'DE', cat:'world',         lang:'de' },
  { url:'https://www.heise.de/rss/heise.rdf',                 src:'Heise',           country:'DE', cat:'technology',    lang:'de' },

  // ── Italy ──
  { url:'https://www.ansa.it/sito/notizie/mondo/mondo_rss.xml', src:'ANSA',          country:'IT', cat:'world',         lang:'it' },
  { url:'https://www.gazzetta.it/rss/calcio.xml',              src:'Gazzetta',       country:'IT', cat:'sports',        lang:'it' },
  { url:'https://www.corriere.it/rss/homepage.xml',            src:'Corriere',       country:'IT', cat:'world',         lang:'it' },

  // ── Portugal ──
  { url:'https://www.publico.pt/api/feeds/rss',               src:'Público PT',      country:'PT', cat:'world',         lang:'pt' },
  { url:'https://www.record.pt/rss',                          src:'Record',          country:'PT', cat:'sports',        lang:'pt' },
  { url:'https://observador.pt/feed/',                        src:'Observador',      country:'PT', cat:'world',         lang:'pt' },

  // ── Netherlands ──
  { url:'https://feeds.nos.nl/nosnieuwsalgemeen',             src:'NOS',             country:'NL', cat:'world',         lang:'nl' },
  ...
  // ── Russia & Ukraine (English sources) ──
  ...
  { url:'https://www.haber.com.tr/rss',                       src:'Haber TR',        country:'TR', cat:'world',         lang:'tr' },
  ...
  { url:'https://www.koreatimes.co.kr/rss/',                  src:'Korea Times',     country:'KR', cat:'world',         lang:'en' },
  ...
  { url:'https://www.infobae.com/feeds/rss/',                 src:'Infobae AR',      country:'AR', cat:'world',         lang:'es' },
  { url:'https://www.clarin.com/rss/ultimas_noticias.xml',    src:'Clarín AR',       country:'AR', cat:'world',         lang:'es' },
  ...
  { url:'https://www.larepublica.co/rss/economia',            src:'La República CO', country:'CO', cat:'world',         lang:'es' },

  // ── Brazil (more) ──
  { url:'https://feeds.folha.uol.com.br/emcimadahora/rss091.xml', src:'Folha',       country:'BR', cat:'world',         lang:'pt' },
